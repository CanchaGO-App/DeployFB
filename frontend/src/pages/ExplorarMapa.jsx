...
export default function ExplorarMapa() {
  ...
  const listadoContent = cargando ? (
    ...
    locales.map((local) => (
      ...
      >
        {getLocalImg(local) ? (
          // HARDCODED: local.imagen_portada_url ? (
          <img
          ...
          />
          // HARDCODED: src={local.imagen_portada_url}
        ) : (
          <div style={{
            width: 52, height: 52,
    ...
    <>
      ...
      <div className="page">
        ...
        <div className="explorar-layout">
          {/* Mapa con SearchBar overlay */}
          <div className="explorar-mapa-wrapper">
            <div className="explorar-search-overlay">
          ...
          <div className="explorar-sidebar-desktop">
